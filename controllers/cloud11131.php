...
class Cloud11131 extends NF_Controller {
	// 1.基礎設定
	private $code_name = 'cloud11131'; // 程式編號
	...
	*/
	...
	switch ($rule['applyItem']) {
		case 'A':
			$rule['applyItem']['A']='第一次使用';
			break;
		case 'B':
			$rule['applyItem']['B']='續租';
			break;
	...
	*/
	...
	$pdf->MultiCell(4*$pdf_width,2, '註:申請表單列印蓋章後，請送至計算機與網路中心4樓網路與資訊安全組。', 0, 'C', 0, 0, '', '', false, '', true, false, 2, 'M');		
