...
*
*/
class Cloud12111_a extends NF_Controller {
	// 1.基礎設定
	private $code_name = 'cloud12111_a'; // 程式編號
	...
	private $model_setting = array (
			...
			*/	
			        'update_datetime' => 'upddate',   // 更改日期20130917
				//  'update_time' => 'updtime',       // 更改時間15:10:15
				    'update_id'   => 'upduser',       // 更改使用者
				    'update_datetime'   => 'updip'    // 更改IP
	...
	private $show_field = array (
		   ...
		   'os' => array (
			...
			'version' => array (
					'chi_name' => '作業系統版本',	
					'grid'     => array('width'=>100),						
					'form'     => array('editable'=>'11','initial'=> '101'), 
					'query'    => false,
					'validate'=>'required',
					'export'   =>array('excel'=>20,'pdf'=>40)	
			),	
